...
export default defineConfig({
  ...
  themeConfig: {
    nav: [
      ...
      { text: 'Docs', link: '/' },
      { text: 'GitHub', link: 'https://github.com/dependencies-org/espcontrol' },
    ],
    ...
    editLink: {
      pattern: 'https://github.com/dependencies-org/espcontrol/edit/main/docs/:path',
      text: 'Edit this page on GitHub',
    },

    socialLinks: [{ icon: 'github', link: 'https://github.com/dependencies-org/espcontrol' }],
